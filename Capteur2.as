onClipEvent (enterFrame) {
	...
	if(_root.distance("top","but")<300){
		...
		protation2=Math.atan2 ( (_root.ter.potohg._y-_root.ter.top._y), (_root.ter.potohg._x-_root.ter.top._x) )
		...
		}else if(_root.distance("potohg","top")<((_root.ter.potohg._height/2)+(_root.ter.top._height/2)+(_root.top_vit*(psit2/130)))&&tps>5&&_root.top_z<17){
		...
		if(_root.ter.petifilethg.hitTest(_root.ter.top)&&tps2>10&&_root.top_z<17){
			_root.ter.top._rotation=180-_root.ter.top._rotation; 
			tps2=0;
			_root.top_vit*=0.5
		}else if(_root.ter.petifilethd.hitTest(_root.ter.top)&&tps2>10&&_root.top_z<17){
			_root.ter.top._rotation=180-_root.ter.top._rotation; 
			tps2=0
			_root.top_vit*=0.5
		}
